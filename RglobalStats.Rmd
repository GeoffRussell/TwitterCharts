...
makeRollingGraph<-function(rp,ntop=30,rmTypes=c("SolarPlusWindPlusBio","Clean")) {
    ...
    p<-top15 %>% mutate(Key=paste0(Rank,". ",Country,", ",MaxYear,", ",comma2(as.numeric(MaxPop)/1e6),"m")) %>%
      ...
      png(paste0("rollout-top-",theyear,"-",ntop,"-over-",rp,"-years-",t,".png"),width=2200,height=1300,units="px",res=300,type="cairo-png")
      print(p)
      dev.off()
      print(p)
}
...
p
png("megawatt-hours-per-person-increase-",theyear,".png",width=1800,height=800,units="px",res=300,type="cairo-png")
p
dev.off()
```
...
#--------------------------------------------------------------------------------------
png("cleanish-megawatt-hours-per-person-",theyear,".png",width=1800,height=800,units="px",res=300,type="cairo-png")
p
dev.off()
```

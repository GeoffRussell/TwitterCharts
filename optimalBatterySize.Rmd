...
doplot<-function(res,pow,scaleTo,tag,blimit=0) {
  ...
  p<-res |> ggplot() + 
    ...
    labs(x="",y="Megawatts",title=paste0("Smoothing a ",pow," MW solar farm with a batteries"),subtitle=paste0("The cyan curve shows the output smoothed by the  use of the battery\n",tag))
...
```{r}
dopng("QLD-solar-baseload-52l19",lqld52g1gl19[[1]])
dopng("QLD-solar-baseload-battery-52l19",lqld52g1gl19[[2]])
dopng("QLD-solar-baseload-makeup-52l19",lqld52g1gl19[[3]])

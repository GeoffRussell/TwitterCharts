...
#---------------------------------------------------------------------------
fulldf<-twh %>% getCountryData(clist$Country) %>% mutate(MWhPerCap=TWh*1e9/Popn/1e6)
fulldfEx<-twhEx %>% getCountryData(clist$Country) %>% mutate(MWhPerCap=TWh*1e9/Popn/1e6)
```
